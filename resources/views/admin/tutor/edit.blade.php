    ...
    <div class="col-md-6 ">
        ...
        <div class="card">
            <div class="card-header pb-1 card-footer">
                <h3 class="card-title">Tambah Tutor</h3>

                <div class="card-tools">
                    <a href="{{ route('admin.tutor.index') }}" class="btn btn-warning btn-sm">
                        ...
                        <div class="col-md-12">
                            <div class="form-group  ">
                                ...
                                <input type="text" name="username" required=""
                                    ...
                                    value="{{ old('username', $tutor->username) }}">
                                @error('username')
